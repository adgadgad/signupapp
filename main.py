...
def login(username, password):
    ...
    if row:
        ...
        return "No username found. or maybe it has been expired"
...
def menu():
    answeruser = input("Do you want to log in or create account, type L for login or C for creating account: ")
    if answeruser == "L":
        username = input("Enter username: ")
        password = input("Enter password: ")
        dothing(username, password)
    elif answeruser == "C":
